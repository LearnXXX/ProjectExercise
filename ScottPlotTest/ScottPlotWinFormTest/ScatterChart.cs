...
namespace ScottPlotWinFormTest
{
    public partial class ScatterChart : Form
    {
        public ScatterChart()
        {
            ...
            //显示次要刻度的网格线
            var grid = formsPlot1.Plot.Grid;
            grid.XAxisStyle.MajorLineStyle.Color = Colors.Red.WithOpacity(.15);
            grid.YAxisStyle.MajorLineStyle.Color = Colors.Green.WithOpacity(.15);
            grid.YAxisStyle.MinorLineStyle.Width = 1;
